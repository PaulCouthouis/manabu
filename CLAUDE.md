...
- **Composants React — pas de logique inline** : extraire toute logique (calculs, détection DOM, gestion de ressources) dans des fonctions pures testables. Les composants React ne contiennent que du rendu et du wiring (atoms, fonctions pures, passage de props). Pas de hooks custom — utiliser les atoms Effect pour les side effects et les fonctions pures pour la logique.
